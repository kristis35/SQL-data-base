<?php
	...
	$breadcrumbItems = array(array('link' => 'index.php', 'title' => 'Pradžia'), array('link' => "index.php?module={$module}&action=list", 'title' => "Miestai"), array("title" => !empty($id) ? "Miesto redagavimas" : "Naujas Miestas"));
