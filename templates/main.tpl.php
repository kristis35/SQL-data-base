            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link <?php if($module == 'car') { echo 'active'; } ?>" href="index.php?module=car&action=list">Mantijos</a></li>
                        <li class="nav-item"><a class="nav-link <?php if($module == 'brand') { echo 'active'; } ?>" href="index.php?module=brand&action=list">Miestai</a></li>
                        <li class="nav-item"><a class="nav-link <?php if($module == 'model') { echo 'active'; } ?>" href="index.php?module=model&action=list">Dalinimo vietos</a></li>
                        <li class="nav-item"><a class="nav-link <?php if($module == 'employee') { echo 'active'; } ?>" href="index.php?module=employee&action=list">Saskaitos</a></li>
                    </ul>
                </div>
            </div>
        </nav>
